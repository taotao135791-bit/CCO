...
const DEFAULT_CONFIG: AppConfig = {
  ...
  providers: [
    ...
    },
    {
      ...
      models: ['kimi-k2.6', 'kimi-k2.5', 'kimi-for-coding'],
    },
    // OpenRouter 聚合路由
    {
      name: 'openrouter',
    ...
    },
    {
      ...
      models: ['gpt-5.5', 'gpt-5.4', 'gpt-5', 'gpt-5-mini', 'o4-mini', 'o3'],
    },
    {
      name: 'gemini',
      format: 'openai',
      ...
      models: ['gemini-3.5-pro', 'gemini-3.5-flash', 'gemini-2.5-pro', 'gemini-2.5-flash'],
    },
    {
      name: 'siliconflow',
      format: 'openai',
    ...
    // 智谱 AI (GLM / ZhipuAI)
    {
      ...
      models: ['glm-5.1', 'glm-5', 'glm-5-turbo', 'glm-4.7', 'glm-4.7-flash', 'glm-4.5-air'],
    },
